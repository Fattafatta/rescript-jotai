...
@ocaml.doc("Creates an atomFamily. If the compiler has trouble inferring the type,
...
@ocaml.doc("Creates an atomFamily with a supplied comparison function
...
@ocaml.doc("Removes an atom from an atomFamily.
...
@ocaml.doc("Registers a shouldRemove function.
...
@ocaml.doc("Unregisters the shouldRemove function.
