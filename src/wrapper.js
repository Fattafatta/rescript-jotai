...
const { atomWithDefault, atomWithRefresh } = require("jotai/utils");
...
/**
 * Wraps a standard atom
 */
exports.atomWrapped = wrapper(atom);
...
/**
 * Wraps an atomWithRefresh
 */
exports.atomWithRefreshWrapped = wrapper(atomWithRefresh);
